...
Use these instruction files to have an AI coding agent migrate your Unity project from **AppLovin MaxSdk 8.6.0** to **MeticaSdk 2.2.1**.
...
2. **MeticaSdk 2.2.1** `.unitypackage` imported into the project
3. **Credentials ready:**
...
- [API Comparison Document](../MaxSdk-8.6.0-vs-MeticaSdk-2.2.1-API-Comparison.md) — full side-by-side API comparison
